local recipes = {{input = "default:coal_lump", output = "default:stonebrick", time = 10}}
assembler = {}

function assembler.register_recipe(recipe)
...
local function allow_metadata_inventory_move(pos, from_list, from_index, to_list, to_index, count, player)
	...
	if to_list == "output" then
		return 0
	elseif to_list == "input" and inv:is_empty("input") and inv:is_empty("output") and meta:get_float("done") == 0.0 then
		return 1
	else
		return 0
	end
...
local function allow_metadata_inventory_put(pos, listname, index, stack, player)
	...
	if listname == "output" then
		return 0
	elseif listname == "input" and inv:is_empty("input") and inv:is_empty("output") and meta:get_float("done") == 0.0 then
		return 1
	else
		return 0
	end
...
assembler.register_recipe({input = "default:coal_lump", output = "default:stonebrick", time = 10})